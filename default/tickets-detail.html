...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Support Ticket Details | UBold - Responsive Admin Dashboard Template</title>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="media">
                                                    <img src="../assets/images/users/user-2.jpg" alt="Arya S"
                                                        class="rounded-circle mr-2" height="24" />
                                                    <div class="media-body">
                                                        <p> Thelma Fridley </p>
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media">
                                            <img class="mr-2 rounded-circle" src="../assets/images/users/user-9.jpg"
                                        ...
                                        <div class="media mt-3">
                                            <img class="mr-2 rounded-circle" src="../assets/images/users/user-2.jpg"
                                                alt="Generic placeholder image" height="32">
                                            <div class="media-body">
                                        ...
                                        <div class="media mt-3">
                                            <a class="pr-2" href="#">
                                                <img src="../assets/images/users/user-9.jpg" class="rounded-circle"
                                                    alt="Generic placeholder image" height="32">
                                            </a>
                                            <div class="media-body">
